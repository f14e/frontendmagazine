...
Реализовать базовый функционал не слишком сложно, но есть большая библиотека, используемая многими проектами, и это [ReactiveX](http://reactivex.io/), аналогом которой в JavaScript является [RxJS](https://rxjs.dev/).
