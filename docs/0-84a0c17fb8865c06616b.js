    ...
    164: function(t, e, n) {
      (function(e) {
        ...
        var v = function(t, e, n) {
            ...
            if (!T(t)) throw new Error("Lightness is not a number");
            t > 100 && (t = 100), t < 0 && (t = 0);
            var r = 0;
            0 !== e &&
        ...
        var _,
          ...
          K = function(t, e, n) {
            var r = t[e];
            (V.call(t, e) && Q(r, n) && (void 0 !== n || e in t)) || $(t, e, n);
          },
          J = Array.isArray,
          X = function(t) {
          ...
          ve = function(t) {
            return (function(t, e, n, r) {
              ...
              for (var i = -1, a = e.length; ++i < a; ) {
                ...
                void 0 === c && (c = t[u]), o ? $(n, u, c) : K(n, u, c);
              }
              return n;
            })(t, Te(t));
          },
              ...
              toJSON: function() {
                return (function(t, e) {
                  ...
                  (n = gn(n, "html", {
                    ...
                    (n = gn(n, "body", {
                      color: e.bodyColor,
                      fontFamily: e.bodyFontFamily.map(vn).join(","),
                  ...
                  (o = (function(t) {
                    ...
                    (n = gn(n, ["h1", "h2", "h3", "h4", "h5", "h6"], {
                      color: e.headerColor,
                      fontFamily: e.headerFontFamily.map(vn).join(","),
                  ...
                  return (
                    te([i, a, u, c, l, s], function(t, r) {
                      (n = Pt(n, "h" + (r + 1) + ".fontSize", t.fontSize)),
                        (n = Pt(
                          n,
                          "h" + (r + 1) + ".lineHeight",
                          e.headerLineHeight
                    ...
                    e.overrideStyles &&
                      N(e.overrideStyles) &&
                      (n = we(n, e.overrideStyles(t, e, n))),
                    e.overrideThemeStyles &&
                      N(e.overrideThemeStyles) &&
                      (n = we(n, e.overrideThemeStyles(t, e, n))),
                    n
                  );
                })(l, c);
              },
        ...
        var l,
          ...
          A = function(t, e) {
            var n = t.baseTag,
              ...
              p = t.title,
              d = t.titleAttributes;
            w(u.TAG_NAMES.BODY, r), w(u.TAG_NAMES.HTML, o), O(p, d);
            var h = {
...
//# sourceMappingURL=0-84a0c17fb8865c06616b.js.map
