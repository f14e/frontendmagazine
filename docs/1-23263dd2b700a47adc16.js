          ...
          for (var t = [], e = 0; e < arguments.length; e++) {
            ...
            if (r) {
              ...
              if ("string" === i || "number" === i)
                t.push((this && this[r]) || r);
              else if (Array.isArray(r)) t.push(o.apply(this, r));
              else if ("object" === i)
                for (var a in r)
                  n.call(r, a) && r[a] && t.push((this && this[a]) || a);
            }
          }
          return t.join(" ");
        }
    ...
    167: function(t, e, n) {
      (function(e) {
        ...
        var _,
          ...
          F = (_ = /[^.]+$/.exec((k && k.keys && k.keys.IE_PROTO) || ""))
            ? "Symbol(src)_1." + _
            : "",
          ...
          J = function(t, e, n) {
            var r = t[e];
            (K.call(t, e) && V(r, n) && (void 0 !== n || e in t)) || $(t, e, n);
          },
          X = Array.isArray,
          Z = function(t) {
          ...
          Q = function(t) {
            return "symbol" == typeof t || (Z(t) && "[object Symbol]" == C(t));
          },
          tt = /\.|\[(?:[^[\]]*|(["'])(?:(?!\1)[^\\]|\\.)*?\1)\]/,
          et = /^\w*$/,
          nt = function(t, e) {
        ...
        var ut = at,
          ct = function(t, e) {
            for (var n = t.length; n--; ) if (V(t[n][0], e)) return n;
            return -1;
          },
        ...
        function gt(t, e) {
          ...
          return (n.cache = new (gt.Cache || bt)()), n;
        }
        gt.Cache = bt;
        var vt = gt,
          Tt = /[^.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|$))/g,
          ...
          _t = j ? j.prototype : void 0,
          At = _t ? _t.toString : void 0,
          St = function t(e) {
          ...
          Mt = function(t, e, n) {
            return null == t
              ...
              : (function(t, e, n, r) {
                  if (!I(t)) return t;
                  for (
                    var o = -1, i = (e = Ot(e, t)).length, a = i - 1, u = t;
                    null != u && ++o < i;
          ...
          Lt = function(t) {
            return Z(t) && "[object Arguments]" == C(t);
          },
          xt = Object.prototype,
          ...
          Nt = Lt(
            ...
            ? Lt
            : function(t) {
                return Z(t) && Ct.call(t, "callee") && !It.call(t, "callee");
              },
          kt = function() {
            return !1;
          },
          Ft = E(function(t, e) {
            var n = e && !e.nodeType && e,
              r = n && t && !t.nodeType && t,
              o = r && r.exports === n ? O.Buffer : void 0;
        ...
        (zt["[object Float32Array]"] = zt["[object Float64Array]"] = zt[
          ...
          "[object Uint8Array]"
        ] = zt["[object Uint8ClampedArray]"] = zt["[object Uint16Array]"] = zt[
          "[object Uint32Array]"
        ] = !0),
        ...
        var ne = ee,
          re = function(t, e, n) {
            ((void 0 === n || V(t[e], n)) && (void 0 !== n || e in t)) ||
              $(t, e, n);
          },
          oe = E(function(t, e) {
            var n = e && !e.nodeType && e,
          ...
          Te = function(t) {
            return (function(t, e, n, r) {
              ...
              for (var i = -1, a = e.length; ++i < a; ) {
                ...
                void 0 === c && (c = t[u]), o ? $(n, u, c) : J(n, u, c);
              }
              return n;
            })(t, ve(t));
          },
                ...
                (s = c),
                  p || d || h
                    ? X(u)
                      ...
                      : (s = [])
                    : (function(t) {
                        if (!Z(t) || "[object Object]" != C(t)) return !1;
                        var e = le(t);
                        if (null === e) return !0;
            ...
            !(function t(e, n, r, o, i) {
              e !== n &&
                Rt(
                  n,
                  function(a, u) {
                    if (I(a)) i || (i = new ne()), me(e, n, u, r, t, o, i);
                    else {
        ...
        ((Ue && "[object DataView]" != Xe(new Ue(new ArrayBuffer(1)))) ||
          ...
          (De && "[object Promise]" != Xe(De.resolve())) ||
          (We && "[object Set]" != Xe(new We())) ||
        ...
        var Ze,
          ...
          on = function(t, e, n, r, o, i) {
            ...
            return (
              ...
              (function(t, e, n, r, o, i) {
                ...
                for (var l = c; l--; ) {
                  var s = u[l];
                  if (!(a ? s in e : Ge.call(e, s))) return !1;
                }
                var f = i.get(t);
          ...
          pn = function(t, e) {
            return (
              null != t &&
              (function(t, e, n) {
                for (var r = -1, o = (e = Ot(e, t)).length, i = !1; ++r < o; ) {
                  var a = Pt(e[r]);
              ...
              toJSON: function() {
                return (function(t, e) {
                  ...
                  (n = gn(n, "html", {
                    ...
                    (n = gn(n, "img", { maxWidth: "100%" }));
                  var o;
                  (o = (function(t) {
                    return (
                      "number" == typeof t ||
                      (Z(t) && "[object Number]" == C(t))
                    );
                  })(e.blockMarginBottom)
                    ...
                    (n = gn(n, "li", { marginBottom: "calc(" + o + " / 2)" })),
                    (n = gn(n, ["ol li", "ul li"], { paddingLeft: 0 })),
                    (n = gn(n, ["li > ol", "li > ul"], {
                      marginLeft: t.rhythm(1),
                    ...
                    (n = gn(n, "th:first-child,td:first-child", {
                      paddingLeft: 0,
                    })),
                    (n = gn(n, "th:last-child,td:last-child", {
                      paddingRight: 0,
                    })),
                    (n = gn(n, ["h1", "h2", "h3", "h4", "h5", "h6"], {
                      color: e.headerColor,
    ...
    168: function(t, e, n) {
      ...
      var a = {
        ...
        overrideStyles: function(t) {
          ...
          return {
            h1: {
              borderBottom: "1px solid " + (0, i.default)(93),
              paddingBottom: "calc(" + e(0.25) + " - 1px)",
              marginBottom: e(0.75),
              marginTop: e(1.5),
            },
            h2: {
            ...
            h6: { color: (0, i.default)(47) },
            "h3,h4,h5,h6": { marginBottom: e(0.5), marginTop: e(1) },
            "ol,ul": { marginLeft: e(1.25) },
            "li>ol,li>ul": { marginLeft: e(1.25) },
            a: { color: "#4078c0", textDecoration: "none" },
            "a:hover,a:active": { textDecoration: "underline" },
            blockquote: {
              borderLeft: "4px solid " + (0, i.default)(87),
              color: (0, i.default)(47),
              marginTop: 0,
              marginRight: 0,
              marginLeft: 0,
              paddingLeft: "calc(" + e(0.5) + " - 1px)",
            },
          };
        },
      };
        ...
        var l,
          ...
          A = function(t, e) {
            var n = t.baseTag,
              ...
              p = t.title,
              d = t.titleAttributes;
            j(u.TAG_NAMES.BODY, r), j(u.TAG_NAMES.HTML, o), O(p, d);
            var h = {
                baseTag: w(u.TAG_NAMES.BASE, n),
                linkTags: w(u.TAG_NAMES.LINK, i),
                metaTags: w(u.TAG_NAMES.META, a),
                noscriptTags: w(u.TAG_NAMES.NOSCRIPT, c),
                scriptTags: w(u.TAG_NAMES.SCRIPT, s),
                styleTags: w(u.TAG_NAMES.STYLE, f),
              },
              b = {},
              y = {};
...
//# sourceMappingURL=1-23263dd2b700a47adc16.js.map
